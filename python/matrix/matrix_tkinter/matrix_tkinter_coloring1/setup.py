...
setuptools.setup(
    ...
    url="https://github.com/vadym/examples/python/matrix_8x8/matrix_tkinter_coloring1",
    ...
    #install_requires=[''],
    entry_points={'console_scripts': ['matrix_tkinter_coloring1 = matrix_tkinter_coloring1.cli:main']},
)
