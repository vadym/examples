...
setuptools.setup(
    name='matrix_tkinter_coloring_8x8',
    version='1.0',
    ...
    url="https://github.com/vadym/examples/python/matrix_8x8/matrix_tkinter_coloring_8x8",
    ...
    #install_requires=[''],
    entry_points={'console_scripts': ['matrix_tkinter_coloring_8x8 = matrix_tkinter_coloring_8x8.cli:main']},
)
